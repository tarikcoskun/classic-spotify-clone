        ...
        <div className={s.rightSide}>
          <div className={s.stats}>
            <div className={s.stat}>
              <div className={classNames(s.title, s.big)}>{new Intl.NumberFormat("en-US").format(data.stats.followers)}</div>
              <div className={s.description}>Followers</div>
            </div>
            <div className={s.stat}>
              <div className={classNames(s.title, s.big)}>{new Intl.NumberFormat("en-US").format(data.stats.monthlyListeners)}</div>
          ...
          <div className={s.topCities}>
            {data.stats.topCities.items.map((stat, idx) => (
              <div className={s.stat} key={idx}>
                ...
                <div className={s.description}>{new Intl.NumberFormat("en-US").format(stat.numberOfListeners)} listeners</div>
              </div>
            ))}
          </div>
